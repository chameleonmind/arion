...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    function isAudioPlusTab(connection, audioPlusTab) {
        // fix to share computer audio along with browser tab screen_share
        return true;
    ...
    (function(connection) {
                    ...
                    if (DetectRTC.browser.name === 'Edge') {
                        navigator.getDisplayMedia({
                            ...
                            if ((session.audio || session.video) && !isAudioPlusTab(connection)) {
                                ...
                                connection.invokeGetUserMedia(sessionForced, function (screen){
                                    screen.isScreen = true;
                                    screen.isVideo = false;
                                    callback(screen);
                                }, nonScreenSession);
                                return;
                            }
                        ...
                        connection.invokeGetUserMedia({
                            ...
                            if ((session.audio || session.video) && !isAudioPlusTab(connection)) {
                                ...
                                connection.invokeGetUserMedia(sessionForced, function(stream){
                                    stream.isScreen = true;
                ...
                if (session.screen) {
                    if (DetectRTC.browser.name === 'Edge') {
                        navigator.getDisplayMedia({
                            ...
                            if ((session.audio || session.video) && !isAudioPlusTab(connection)) {
                                connection.invokeGetUserMedia(null, function(screen){
                                    screen.isScreen = true;
                                    screen.isVideo = false;
                                    gumCallback(screen);
                                });
                        ...
                        connection.invokeGetUserMedia({
                            ...
                            video: true,
                            isScreen: true
                        }, (session.audio || session.video) && !isAudioPlusTab(connection) ? connection.invokeGetUserMedia(null, function(stream){
                            stream.isScreen = true;
                            stream.isVideo = false;
                            gumCallback(stream);
                        }) : function (stream){
        ...
        connection.onMediaError = function(error, constraints) {
            ...
            connection.extra.permissionDeniedScreenShare = true;
        };
